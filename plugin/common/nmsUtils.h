...
size_t tfliteDetectionInferenceWorkspaceSize(bool shareLocation, int N, int C1, int C2, int C3, int numClasses, int numPredsPerClass,
    int topK, DataType DT_BBOX, DataType DT_SCORE, DataType DT_ANCHOR);
